                ...
                (let ((text (song:verse-text verse))
                  ...
                  (receive (rest-list note-listlist) (partition song:rest? note/rest-list)
                    ...
                    (if (not (null? rest-list))
                        (set! rest-duration (+ rest-duration (apply + (map song:rest-duration rest-list)))))
                    (if (not (null? note-listlist))
                        (begin
                          (if (> rest-duration 0)
                              (begin
                                (song:write-rest-element port rest-duration)
                                (set! rest-duration 0)))
...
(define (song:write-rest-element port duration)
